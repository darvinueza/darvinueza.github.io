...
+ Pegamos las siguientes líneas en el archivo **sysctl.conf**.
    ...
    ![odb_2](imgs/centos/odb/odb_2.png)
...
+ En la raíz del directorio */*, ejecutamos el comando *sbin/sysctl -p*.
    ...
    ![odb_3](imgs/centos/odb/odb_3.png)
...
+ Editamos el archivo **limits.conf**.
    ...
    ![odb_4](imgs/centos/odb/odb_4.png)
...
+ Modificamos el nombre del Host, para ello editamos el archivo *hosts*.
    ...
    ![odb_6](imgs/centos/odb/odb_6.png)
...
+ Verificamos la IP del servidor, y le damos el nombre de dominio que creamos conveniente, en mi caso la IP es *192.168.28.133* y el HOST_NAME es *obpm.domain*.
    ...
    ![odb_7](imgs/centos/odb/odb_7.png)
...
1. Nos deslogeamos como *root* y nos logeamos con el usuario que deseamos instalar, en mi caso el usuario se llama *obpm*.
    ...
    ![odb_8](imgs/centos/odb/odb_8.png)
...
12. Modificamos la ruta **Oracle base**, en nuestro caso la ruta por defecto es */home/obpm/app/obpm*, la modificaremos por la ruta  */opt/obpm/app/obpm*.
    ...
    ![odb_19](imgs/centos/odb/odb_19.png)

13. Tenemos la misma ventana con la ruta modificada, click en **Next**. 

    ![odb_20](imgs/centos/odb/odb_20.png)

14. Click en **Next**.

    ![odb_21](imgs/centos/odb/odb_21.png)

15. Seleccionar **General Purpose**, click en **Next**.  

    ![odb_22](imgs/centos/odb/odb_22.png)
...
26. Abrimos una terminal y nos logueamos como usuario *root*, ejecutamos los 2 archivos *.sh* que se visualizan en la grafica.
    ...
    ![odb_33](imgs/centos/odb/odb_33.png)

        # /opt/obpm/app/obpm/product/12.2.0/dbhome_1/root.sh

    ![odb_34](recursos/imgs/centos/odb/odb_34.png)
...
![odb_37](imgs/centos/odb/odb_37.png)   

![odb_38](imgs/centos/odb/odb_38.png)
